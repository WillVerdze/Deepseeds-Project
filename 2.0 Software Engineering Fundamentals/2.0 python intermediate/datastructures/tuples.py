#Tuples are like sealed envelops conataining importand documents
#Once sealed, you cannot change what is inside
#Tuples are like lists but are immutable that is, their content cannot be changed or edited after creation
#This makes tuples perfect for storing data that should ot change.

#Creating tuples - like sealing important information
point_coordinate = (10, 20) # a point in 2D space
...
another_point = 5, 15
single_item_tuple = (42,) #Take not of the comma, it is important!

print(f"Point Coordeinates: {point_coordinate}")
print(f"RGB color: {rgb_color}")
print(f"Student record: {student_record}")
print(f"Sindle item tuple: {single_item_tuple}")

#Accessing tuple elements
#Access is done just like in lists using square brackets

#Working with a tuple representing a book record
book_info = ("1984", "Goearge Orwell", 1949, "Dystopian Fiction")
